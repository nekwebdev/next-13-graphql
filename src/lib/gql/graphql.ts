...
export type GetGlobalQueryQuery = {
  __typename?: 'Query'
  global?: {
    __typename?: 'GlobalEntityResponse'
    data?: {
...
export type GetNavigationQueryQuery = {
  __typename?: 'Query'
  navigation?: {
    __typename?: 'NavigationEntityResponse'
    data?: {
...
export const GetGlobalQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetGlobalQuery' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<GetGlobalQueryQuery, GetGlobalQueryQueryVariables>
export const GetNavigationQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
                                ...
                                selections: [
                                  {
                                    ...
                                    typeCondition: {
                                      kind: 'NamedType',
                                      name: { kind: 'Name', value: 'ComponentMenuDropdown' },
                                    },
                                    selectionSet: {
                                      kind: 'SelectionSet',
                                      selections: [
                                            ...
                                            selections: [
                                              {
                                                ...
                                                typeCondition: {
                                                  ...
                                                  name: {
                                                    kind: 'Name',
                                                    value: 'SectionRelationResponseCollection',
                                                  },
                                                },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                  ...
                                  },
                                  {
                                    ...
                                    typeCondition: {
                                      kind: 'NamedType',
                                      name: { kind: 'Name', value: 'ComponentMenuLink' },
                                    },
                                    selectionSet: {
                                      kind: 'SelectionSet',
                                      selections: [
...
} as unknown as DocumentNode<GetNavigationQueryQuery, GetNavigationQueryQueryVariables>
